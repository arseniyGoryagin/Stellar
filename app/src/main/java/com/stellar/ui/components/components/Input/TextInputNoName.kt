...
@Composable
fun TextInputNoName( startValue : String = "", placeholder :String = "", modifier: Modifier = Modifier, icon : @Composable () -> Unit, trailingIcon : @Composable () -> Unit, onValueChange : (String) -> Unit, visibleText : Boolean){
